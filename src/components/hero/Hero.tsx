...
export function Hero() {
  ...
  return (
    <section className="relative pt-20 pb-14 lg:pt-24 lg:pb-20 overflow-hidden">
      ...
      {/* Warm Ambient Sunlight Radial Glow */}
      <div className="absolute top-1/3 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[900px] h-[600px] bg-amber-200/20 rounded-full blur-3xl pointer-events-none z-0" />
